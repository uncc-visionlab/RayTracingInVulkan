...
### Addendum for linux users building this project without using Microsoft's vcpkg:
...
```
```
export VULKAN_SDK=$HOME/bin/vulkansdk-linux-x86_64-1.2.176.1/1.2.176.1/x86_64
